...
import { X, ArrowRight, ArrowLeft, Plus, Globe, MessageCircle, Zap, Shield, Rocket, CheckCircle, ImageIcon, Loader2, Coins, Sparkles } from 'lucide-react';
import { supabase } from '../../lib/supabase';

const NETWORKS = [
  { id: 'BSC', label: 'BNB Smart Chain', color: '#F0B90B', token: 'BNB', target: 18 },
                    ...
                    <div className="mt-3 p-3 bg-[#0B0E11] rounded-xl space-y-1.5">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-white text-xs font-bold">
                          ${((parseFloat(initialBuy) || 0) * (selectedNetwork.token === 'BNB' ? 600 : selectedNetwork.token === 'SOL' ? 150 : 3500)).toFixed(0)}
                        </span>
                      </div>
                    </div>
                  )}
