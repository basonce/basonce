...
import { ChevronRight, Users, X, ArrowLeft, Shield, AlertTriangle, Check, Loader2, StopCircle, ChevronDown } from 'lucide-react';
  ...
  return (
    <>
      <div className="bg-[#181A20] border-t border-[#2B3139]">
        <div
          className="flex items-center justify-between px-4 py-2.5 cursor-pointer active:bg-[#2B3139]/30"
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2.5">
                  <img src={trader.avatar_url} alt="" className="w-9 h-9 rounded-full object-cover border border-[#2B3139]" />
                  <div>
            ...
            {copySuccess ? (
              ...
              <div className="p-4">
                <div className="flex items-center gap-3 mb-4 p-3 bg-[#1E2329] rounded-lg">
                  <img src={showDetail.avatar_url} alt="" className="w-10 h-10 rounded-full object-cover" />
            ...
            {allTraders.map((trader) => (
              ...
              >
                <div className="flex items-center gap-2.5 flex-1 min-w-0">
                  <img src={trader.avatar_url} alt="" className="w-8 h-8 rounded-full object-cover flex-shrink-0" />
          ...
          <div key={copy.id} className="p-3">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                <img src={trader.avatar_url} alt="" className="w-7 h-7 rounded-full object-cover" />
                <div>
