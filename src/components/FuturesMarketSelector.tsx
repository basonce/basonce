            ...
            filtered.map((market) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="w-6 h-6 rounded-full bg-[#2B3139] flex items-center justify-center overflow-hidden flex-shrink-0">
                    {market.logo ? (
                      <img
                        src={market.logo}
                        alt=""
                        ...
                        onError={(e) => {
                          ...
                          if (p) p.innerHTML = `<span class="text-white font-bold text-[10px]">${market.displaySymbol.slice(0, 2)}</span>`;
                        }}
                      />
                    ) : (
                      <span className="text-white font-bold text-[10px]">{market.displaySymbol.slice(0, 2)}</span>
                    )}
                  </div>
