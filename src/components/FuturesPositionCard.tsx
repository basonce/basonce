  ...
  return (
    <>
      <div className="bg-[#181A20] rounded-lg p-3 mb-3">
        {isHighRisk && (
          <div className="mb-3 p-2 bg-[#F6465D]/10 border border-[#F6465D]/30 rounded flex items-center gap-2">
            <AlertTriangle className="w-4 h-4 text-[#F6465D]" />
            <div className="flex-1">
              <div className="text-xs font-semibold">High Risk - Close to Liquidation!</div>
              <div className="text-[10px]">
                Price is {distanceToLiq.toFixed(2)}% away from liquidation. Add margin or close position.
              </div>
            </div>
          </div>
        )}
        {isMediumRisk && !isHighRisk && (
          <div className="mb-3 p-2 bg-[#F0B90B]/10 border border-[#F0B90B]/30 rounded flex items-center gap-2">
            <AlertTriangle className="w-4 h-4 text-[#F0B90B]" />
            <div className="flex-1">
              <div className="text-xs font-semibold">Medium Risk</div>
              <div className="text-[10px]">
                Monitor your position closely. Consider adding margin if needed.
              </div>
            </div>
          </div>
        )}
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className={`text-[10px] px-1.5 py-0.5 rounded ${ marginMode === 'cross' ? 'bg-[#F0B90B]/20 text-[#F0B90B]' : 'bg-[#0ECB81]/20 text-[#0ECB81]' }`}>
