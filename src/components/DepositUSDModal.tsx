          ...
          <div className="px-4 mb-6">
            ...
            <div className="grid grid-cols-4 gap-2">
              {popularCoins.map((coin) => (
                <button
                  key={coin.symbol}
                  className="bg-[#181A20] rounded-xl p-3 border border-[#2B3139] hover:border-[#F0B90B]/50 transition-all"
                >
                  <img src={coin.logo} alt={coin.name} className="w-8 h-8 mx-auto mb-1" />
