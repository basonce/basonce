...
export default function ProfilePage({ onNavigateToAdmin }: ProfilePageProps) {
  ...
  const loadUserData = async () => {
    try {
      ...
      await loadBalances(session.user.id);
    } catch (error) {
    ...
    <div className="min-h-screen bg-[#181A20] pb-20">
      ...
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            onClick={resetMiningForTesting}
            disabled={resettingMining}
            className="w-full bg-[#F0B90B]/10 text-[#F0B90B] rounded-xl p-4 flex items-center justify-center transition-all hover:scale-[1.01] active:scale-[0.99] font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {resettingMining ? (
              <>
              ...
              <>
                ...
                <span>Reset Mining Test Mode</span>
              </>
            )}
          </button>
          ...
          <button
            ...
            className="w-full bg-red-500/10 text-red-500 rounded-xl p-4 flex items-center justify-center transition-all hover:scale-[1.01] active:scale-[0.99] font-semibold"
          >
