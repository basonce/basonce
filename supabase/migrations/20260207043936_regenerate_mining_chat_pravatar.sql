/*
  # Regenerate Mining Chat Messages with Pravatar

  1. Changes
    - Delete old messages
    - Recreate with Pravatar avatars
*/

-- Delete old mining chat messages
DELETE FROM mining_chat_messages;

-- Insert 10,000 chat messages with Pravatar avatars from anonymous_profiles
DO $$
DECLARE
...
BEGIN
  ...
  FOR i IN 1..10000 LOOP
    ...
    INSERT INTO mining_chat_messages (
      ...
      'https://i.pravatar.cc/150?img=' || (profile_rec.id % 70 + 1),
      v_message,
      v_type,
      v_amount,
      v_level,
  ...
  RAISE NOTICE 'Successfully generated 10,000 mining chat messages with Pravatar avatars';
END $$;
